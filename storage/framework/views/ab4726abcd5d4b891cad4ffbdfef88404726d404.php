						...
						<tbody>
                        	...
                        	<tr>
                            	...
                            	<td class="text-center">
                                	...
                                	<a href="<?php echo e(route('masterproject.tambah', $item->id )); ?>" class="btn btn-info"><i class="fas fa-plus"></i></a>
                            	</td>
                        	</tr>
...
<?php echo $__env->make('master.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kevin\resources\views/master/masterproject.blade.php ENDPATH**/ ?>
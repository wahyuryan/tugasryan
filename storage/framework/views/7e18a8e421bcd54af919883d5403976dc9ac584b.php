    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-4">
            <div style="font-weight: 500; " class=""> 
                <a href="<?php echo e(route('mastersiswa.create')); ?>" class="btn btn-success">TambahData</a>
            </div>
            </div>
            <div class="card-body">
            <table class="table">
...
<?php echo $__env->make('master.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kevin\resources\views/master/mastersiswa.blade.php ENDPATH**/ ?>
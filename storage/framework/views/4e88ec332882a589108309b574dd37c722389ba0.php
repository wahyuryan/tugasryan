...
<?php $__env->startSection('content-title', 'Edit Siswa'); ?>
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">  
                <div class="card-body"><div class="card-body">
                    ...
                    <?php endif; ?>
                    <form method="post" enctype="multipart/form-data" action="<?php echo e(route('mastersiswa.update' , $siswa->id)); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <img src="<?php echo e(asset('/template/img/'.$siswa->foto)); ?>" width="300" class="img-thumbnail" alt="">

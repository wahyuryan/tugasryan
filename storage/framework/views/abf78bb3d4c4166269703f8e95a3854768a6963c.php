...
<!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion shadow" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center shadow bg-gradient-primary" href="/dashboard">
        ...
        <!-- End of Sidebar --><?php /**PATH C:\xampp\htdocs\ryan\resources\views/master/sidebar.blade.php ENDPATH**/ ?>
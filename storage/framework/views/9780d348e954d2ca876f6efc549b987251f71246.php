...
<?php if(count($errors) > 0): ?>
                    ...
                    <?php endif; ?>
<form method="post" enctype="multipart/form-data" action="<?php echo e(route('masterproject.store', $siswa->id)); ?>">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('master.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kevin\resources\views/project/TambahProject.blade.php ENDPATH**/ ?>